 ...
 * This file demonstrates how to integrate Chainboost with a web frontend
 */

// For React/Vue/Angular applications
export class ChainboostClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ChainboostClient(provider, contractAddress);
